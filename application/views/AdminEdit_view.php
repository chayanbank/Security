...
<body>
    <div class="row">
        ...
        <tr>
            <td>Student ID: </td>
            <td><input type="text" name="stuID" pattern="[1-9][0-9]{1,}" title="กรอกตัวเลขเท่านั้น" required maxlength="8" minlength="8" value="<?php echo $row["studentID"];?>"> <?php if(isset($studentID)) echo $studentID;?></td>
        </tr>
        <tr>
            <td>First Name: </td>
            <td><input type="text" name="Fname" pattern="[ A-Za-z]{1,}" title="กรอกตัวอักษรภาษาอังกฤษเท่านั้น" required value="<?php echo $row["Fname"];?>"> <?php if(isset($fname)) echo $fname;?></td>
        </tr>
        <tr>
            <td>Last Name: </td>
            <td><input type="text" name="Lname" pattern="[ A-Za-z]{1,}" title="กรอกตัวอักษรภาษาอังกฤษเท่านั้น" required value="<?php echo $row["Lname"];?>"> <?php if(isset($lname)) echo $lname;?></td>
        </tr>
        <tr>
            <td>Faculty: </td>
            <td>
        ...
        <tr>
            <td colspan="2"><input type="submit" value="Edit" name="Edit"> <input type="reset" value="Cancel" name="reset"></td>
        </tr>
        </table>
        </form>
        <?php } ?>
